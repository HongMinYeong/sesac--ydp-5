...
const saltRounds = 10; // 솔트 라운드 수를 정의 -> 이 값이 길 수록 성능에 영향감
...
const isMatch2 = comparePassword('hello word!', hashedPassword);
console.log(`originalPassword === hashedPassword : ${isMatch2}`); //false

// +) db에 추가하기 전에 암호화한 데이터를 pw로 넣기
// 로그인할때도 pw를 암호화해서 db에 있는 pw랑 비교해서 리턴

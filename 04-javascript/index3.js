...
//변수 선언 키워드 1. var
var a; //var 선언 (0) , 할당(x) ->undefined : 값을 할당하지 않았음 
console.log(a);
a = 2; //변수 할당 
...
let b2 = 77; //변수 선언 & 할당 
console.log(b2);
// let b2; //error : let 키워드 중복 선언 불가능 ->  let 키워드는 한번만 가능 
b2 = 78; // 변수 값 재할당 
console.log(b2);
...
console.log(`${text} 저는 민영입니다. 저의 성별은 ${gender}입니다.!`);
//////////////////;//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

...
app.post('/upload', uploadDetail.single('userfile'), (req, res) => {
  ...
  //     originalname: 'wawa1.png', //원본 파일명
  //     encoding: '7bit', //파일 인코딩 타입
  //     mimetype: 'image/png', //파일 타입
  //     destination: 'uploads/', //파일 저장 경로
  //     filename: '3ed976337d9056ba2b1c99042f8e1e94', //destination에 저장된 파일명
  //     path: 'uploads/3ed976337d9056ba2b1c99042f8e1e94', //업로드된 파일 전체 경로
  //     size: 13812 //파일크기
  //   }
});
...
//fields() 의 매개변수로 input 태그의 name을 각각 넣기
app.post(
  '/upload/fields',
